...
You may edit only: `src/lib/assistant/**`, `src/app/actions/interpret-query.ts`, `docs/ai/**`. Anything else belongs to another role; hand it off through the ticket or pull request.
