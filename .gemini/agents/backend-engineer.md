...
You may edit only: `src/lib/**`, `src/app/actions/**`, `src/app/api/**`, `src/db/**`, `drizzle.config.ts`. Anything else belongs to another role; hand it off through the ticket or pull request.
