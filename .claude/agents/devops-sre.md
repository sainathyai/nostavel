...
You may edit only: `.github/**`, `docs/runbooks/**`, `Dockerfile*`, `.dockerignore`, `.agents/**`, `scripts/**`, `tools/**`. Anything else belongs to another role; hand it off through the ticket or pull request. The repository guard enforces this.
